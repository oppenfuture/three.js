...
var GLTFLoader = ( function () {
	 ...
	 */
	 ...
	 function OFTPointSprintMaterial( params ) {

		ShaderMaterial.call( this, params );
		this.type = 'OFTPointSprintMaterial';

	 }

	 OFTPointSprintMaterial.prototype = Object.create( ShaderMaterial.prototype );
	 OFTPointSprintMaterial.prototype.constructor = OFTPointSprintMaterial;

	 OFTPointSprintMaterial.prototype.copy = function ( source ) {
	 ...
	 function GLTFMaterialsPointSpriteExtension() {

		this.name = EXTENSIONS.OFT_MATERIALS_POINT_SPRITE;

	}

	GLTFMaterialsPointSpriteExtension.prototype.getMaterialType = function () {

		return OFTPointSprintMaterial;

	};

	GLTFMaterialsPointSpriteExtension.prototype.extendParams = function ( materialParams, materialDef, parser ) {
		var pending = [];
	...
	GLTFMaterialsPointSpriteExtension.prototype.createMaterial = function ( materialParams ) {
		var uniformsPoint = {
	...
	GLTFParser.prototype.assignFinalMaterial = function ( mesh ) {
		...
		if ( material.type === 'OFTPointSprintMaterial' ) {
